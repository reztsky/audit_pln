...
@endpush
@section('title', 'Create Laporan Hasil Audit (LHA)')
                            ...
                            <div class="w-12/12">
                                <label class="floating-label">
                                    ...
                                    <input type="text" placeholder="Judul LHA" required
                                        class="input input-md w-full validator" name="judul" />
                                </label>
                            </div>
                            <div class="w-12/12">
                                <label class="floating-label">
                            ...
                            <div class="w-12/12">
                                <label class="floating-label">
                                    ...
                                    <input type="date" placeholder="Tanggal Selesai"
                                        class="input input-md w-full validator" name="tanggal" />
                        ...
                        <div class="w-12/12">
                            ...
                            <ul class="list-disc ml-6">
                                @forelse($kertas_kerjas as $item)
                                    <li>{{ $item->kontrol }} - {{ $item->temuan ?? '-' }}</li>
                                @empty
                        ...
                        <div class="w-12/12">
                            ...
                            <select name="id_kertas_kerjas[]" id="id_kertas_kerja"
                                ...
                                @forelse ($kertas_kerjas as $kertas_kerja)
                                    <option value="{{ $kertas_kerja->id }}">{{ $kertas_kerja->kontrol }} -
